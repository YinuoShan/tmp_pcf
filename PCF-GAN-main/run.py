...
# !python3 run.py --gan_algo PCFGAN --dataset rough
def main(config):
    """
    ...
    train_dl, test_dl = get_dataset(config, num_workers=4) # datasets/dataloader
    from src.models import get_trainer

    trainer, generator = get_trainer(config, train_dl, test_dl) # model
